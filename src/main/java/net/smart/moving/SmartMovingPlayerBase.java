...
public class SmartMovingPlayerBase extends ClientPlayerBase
		implements IEntityPlayerSP {
	public SmartMovingSelf moving;

	public static void registerPlayerBase() {
		ClientPlayerAPI.register(SmartMovingInfo.ModName,
				SmartMovingPlayerBase.class);
	}

	public static SmartMovingPlayerBase getPlayerBase(EntityPlayerSP player) {
		return (SmartMovingPlayerBase) ((IClientPlayerAPI) player)
				.getClientPlayerBase(SmartMovingInfo.ModName);
	}
	...
	@Override
	public void beforeMoveEntity(MoverType mover, double d, double d1,
			double d2) {
		moving.beforeMoveEntity(d, d1, d2);
	}

	@Override
	public void afterMoveEntity(MoverType mover, double d, double d1,
			double d2) {
		moving.afterMoveEntity(d, d1, d2);
	}

	@Override
	public void localMoveEntity(MoverType mover, double d, double d1,
			double d2) {
	...
	@Override
	public void beforeSetPositionAndRotation(double d, double d1, double d2,
			float f, float f1) {
